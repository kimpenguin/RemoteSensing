...
curl "http://iridl.ldeo.columbia.edu/expert/SOURCES/.USGS/.LandDAAC/.MODIS/.1km/.8day/.version_005/.Aqua/.EAF/.Day/.LST/T/%28"$Month1"%20"$Year1"%29%28"$Month2"%20"$Year2"%29RANGE%5BT%5Daverage/data.tiff?filename=data.tiff" -o $OutputDir/"$Dataset"_EAF_"$Month1""$Year1"_"$Month2""$Year2".tif
...
curl "http://iridl.ldeo.columbia.edu/expert/SOURCES/.USGS/.LandDAAC/.MODIS/.1km/.8day/.version_005/.Aqua/.SAF/.Day/.LST/T/%28"$Month1"%20"$Year1"%29%28"$Month2"%20"$Year2"%29RANGE%5BT%5Daverage/data.tiff?filename=data.tiff" -o $OutputDir/"$Dataset"_SAF_"$Month1""$Year1"_"$Month2""$Year2".tif
...
curl "http://iridl.ldeo.columbia.edu/expert/SOURCES/.USGS/.LandDAAC/.MODIS/.1km/.8day/.version_005/.Aqua/.WAF/.Day/.LST/T/%28"$Month1"%20"$Year1"%29%28"$Month2"%20"$Year2"%29RANGE%5BT%5Daverage/data.tiff?filename=data.tiff" -o $OutputDir/"$Dataset"_WAF_"$Month1""$Year1"_"$Month2""$Year2".tif
fi
...
curl "http://iridl.ldeo.columbia.edu/expert/SOURCES/.USGS/.LandDAAC/.MODIS/.1km/.8day/.version_005/.Aqua/.EAF/.Night/.LST/T/%28"$Month1"%20"$Year1"%29%28"$Month2"%20"$Year2"%29RANGE%5BT%5Daverage/data.tiff?filename=data.tiff" -o $OutputDir/"$Dataset"_EAF_"$Month1""$Year1"_"$Month2""$Year2".tif
...
curl "http://iridl.ldeo.columbia.edu/expert/SOURCES/.USGS/.LandDAAC/.MODIS/.1km/.8day/.version_005/.Aqua/.SAF/.Night/.LST/T/%28"$Month1"%20"$Year1"%29%28"$Month2"%20"$Year2"%29RANGE%5BT%5Daverage/data.tiff?filename=data.tiff" -o $OutputDir/"$Dataset"_SAF_"$Month1""$Year1"_"$Month2""$Year2".tif
...
curl "http://iridl.ldeo.columbia.edu/expert/SOURCES/.USGS/.LandDAAC/.MODIS/.1km/.8day/.version_005/.Aqua/.WAF/.Night/.LST/T/%28"$Month1"%20"$Year1"%29%28"$Month2"%20"$Year2"%29RANGE%5BT%5Daverage/data.tiff?filename=data.tiff" -o $OutputDir/"$Dataset"_WAF_"$Month1""$Year1"_"$Month2""$Year2".tif
fi
